...
Risk identification is conducted during scheduled assessments and triggered by significant changes to Fenn's systems, operations, or threat environment. Climate change has been assessed as a relevant external issue under ISO 27001:2022 Clause 4.1. The primary exposure for Fenn's ISMS is physical infrastructure resilience to extreme weather events, which is addressed under RR-012 and mitigated by AWS infrastructure controls and the Business Continuity Plan (FENN-PLN-002).
